        ...
        <div class="carousel-inner" role="listbox">
          <div class="carousel-item active">
            ...
            <div class="carousel-caption">
              <h3 class="h3-responsive">Confirmado!</h3>
              <p>Half Life 3 confirmado com modo battle royal</p>
            </div>
          </div>
          <div class="carousel-item">
            ...
            <div class="carousel-caption">
              <h3 class="h3-responsive">E3</h3>
              <p>Principais novidades da ultima E3</p>
            </div>
          </div>
          <div class="carousel-item">
            <!--Mask color-->
            ...
            <div class="carousel-caption">
              ...
              <p>Jogos de Esportes com 30% de desconto as sextas</p>
            </div>
          </div>
        </div>
        <!--/.Slides-->
